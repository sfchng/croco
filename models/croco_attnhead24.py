...
from models.blocks import BlockH24, DecoderBlock, PatchEmbed
from models.pos_embed import get_2d_sincos_pos_embed, RoPE2D 
from models.masking import RandomMask


class CroCoNet_Attnhead24(nn.Module):
    ...
    def __init__(self,
        ...
        super(CroCoNet_Attnhead24, self).__init__()
        ...
        self.enc_blocks = nn.ModuleList([
            BlockH24(enc_embed_dim, enc_num_heads, mlp_ratio, qkv_bias=True, norm_layer=norm_layer, rope=self.rope)
